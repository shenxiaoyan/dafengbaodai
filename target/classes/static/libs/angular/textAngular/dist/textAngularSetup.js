...
//		['justifyLeft','justifyCenter','justifyRight'],
		[ 'insertImage','uploadImage', 'insertLink', 'insertVideo']
	],
	classes: {
		focussed: "focussed",
		toolbar: "btn-toolbar",
		toolbarGroup: "btn-group",
		toolbarButton: "btn btn-link btn-sm",
...
textAngularSetup.constant('taTranslations', {
	...
	uploadImage: "Please enter a image URL to insert",
...
textAngularSetup.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', function(taRegisterTool, $window, taTranslations, taSelection){
	...
	taRegisterTool('uploadImage', {
		...
		action: function(){
			var imageLink;
			imageLink = $window.prompt(taTranslations.insertImage, 'http://还不知道怎么做');
			if(imageLink && imageLink !== '' && imageLink !== 'http://'){
				return this.$editor().wrapSelection('uploadImage', imageLink, true);
			}
		},
		onElementSelect: {
			element: 'img',
