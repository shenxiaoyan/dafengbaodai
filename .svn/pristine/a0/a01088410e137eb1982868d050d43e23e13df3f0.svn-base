...
(function(){ // encapsulate all variables so they don't become global vars
	...
	*/
	...
	if(ie > 8 || ie === undefined){
		...
		_addCSSRule(topsheet, '.ta-scroll-window.form-control', "height: 160px; overflow: auto; font-family: inherit; font-size: 100%; position: relative; padding: 0;border:none;");
		_addCSSRule(topsheet, '.ta-root.focussed .ta-scroll-window.form-control', 'border:none;');
		_addCSSRule(topsheet, '.ta-editor.ta-html', "min-height: 160px; height: auto; overflow: auto; font-family: inherit; font-size: 100%;");
		_addCSSRule(topsheet, '.ta-scroll-window .ta-bind', "height: auto; min-height: 158px; padding:0px 8px 6px 8px;");
