...
public class TableInfoController {
	...
	public Map<String, Object> getInfo(){
		...
		for (Class clazz : listClass) {
			...
			// 获取该类中的所有Field
			fieldList = getAllField(clazz, fieldList);
				...
				if (field.getType().isEnum()) {
					...
					for (Object object : enums) {
						...
						try {
							...
							throw new FailReturnObject(4671, object.getClass().getSimpleName()+"没有field"+object.toString());
						} catch (SecurityException e) {
							// TODO Auto-generated catch block
							throw new FailReturnObject(4691, object.getClass().getSimpleName()+"的"+object.toString()+"无法访问");
						}
			...
			if (object instanceof Field) {
				...
				if (field.getType().getSimpleName().equals("Boolean")
					...
					if (element.getAnnotationsByType(Info.class) != null
						...
						throw new FailReturnObject(ExceptionResultEnum.TABLEINFO_ANNOTATION_ERROR);
//						throw new FailReturnObject(8741, "boolean型变量需要两个注解");
					}
